...
Десять років промислової розробки — і власний трек у Python та ML. Побудував голосовий пайплайн реального часу: faster-whisper на CUDA, діаризація pyannote, VAD і потокова обробка, з регресійними замірами затримки та RTF. Поряд — конвеєри даних на SQLAlchemy і Playwright та щоденна робота з ІІ-агентами.
